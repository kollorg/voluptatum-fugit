...
[![Build Status](https://travis-ci.org/kollorg/voluptatum-fugit.svg?branch=master)](https://travis-ci.org/kollorg/voluptatum-fugit)
...
-   [Codesandbox playground](https://codesandbox.io/s/github/kollorg/voluptatum-fugit/tree/master/codesandbox/default)
-   [Storybook](http://react-responsive-carousel.js.org/storybook/)
-   [Changelog](https://github.com/kollorg/voluptatum-fugit/blob/master/CHANGELOG.md)
-   [Before contributing](https://github.com/kollorg/voluptatum-fugit/blob/master/CONTRIBUTING.md)
-   [Troubleshooting](https://github.com/kollorg/voluptatum-fugit/blob/master/TROUBLESHOOTING.md)

### Demo

<http://leandrowd.github.io/react-responsive-carousel/>

Check it out these [cool demos](http://react-responsive-carousel.js.org/storybook/index.html) created using [storybook](https://storybook.js.org/). The source code for each example is available [here](https://github.com/kollorg/voluptatum-fugit/blob/master/stories/)
...
The [contributing guide](https://github.com/kollorg/voluptatum-fugit/blob/master/CONTRIBUTING.md) contains details on how to create pull requests and setup your dev environment. Please read it before contributing!
...
-   A new option is to create an example with the code that causes the bug. Fork this [example from codesandbox](https://codesandbox.io/s/github/kollorg/voluptatum-fugit/tree/master/codesandbox/default) and add your code there. Don't forget to fork, save and add the link for the example to the issue.
